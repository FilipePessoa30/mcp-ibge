...
`docs/modules/bcb.md` para o roadmap.

Todos os valores são ajustáveis via variáveis de ambiente com prefixo
``MCP_BCB_`` (ou um arquivo ``.env`` na raiz do projeto).
"""
...
# Domínios oficiais permitidos para requisições do mcp-bcb. Vazio por
...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="MCP_BCB_", env_file=".env", extra="ignore"
    )
    ...
    source_name: str = "Banco Central do Brasil"
    source_url: str = "https://www.bcb.gov.br/"
