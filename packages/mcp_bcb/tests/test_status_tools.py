"""Testes de contrato da tool MCP `status` do `mcp-bcb`."""
...
from mcp_bcb.server import mcp
...
async def test_status_tool_returns_envelope() -> None:
    ...
    assert structured["data"]["module"] == "mcp-bcb"
    ...
    assert structured["metadata"]["source_url"] == "https://www.bcb.gov.br/"
