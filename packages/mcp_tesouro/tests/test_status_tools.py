"""Testes de contrato da tool MCP `status` do `mcp-tesouro`."""
...
async def test_status_tool_returns_envelope() -> None:
    ...
    assert structured["data"]["module"] == "mcp-tesouro"
    ...
    assert structured["metadata"]["source_url"] == "https://www.tesourotransparente.gov.br/"
