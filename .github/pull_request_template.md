...
- [ ] New/changed tools follow the [response envelope](https://github.com/FilipePessoa30/mcp-ibge/blob/main/docs/data_sources.md) and the `listar_/obter_/buscar_/consultar_` naming convention
